...
Java_co_airbitz_api_Jni_coreDataSyncAccount(JNIEnv *jenv, jclass jcls, jstring jusername, jstring jpassword, jlong jerrorp) {
  jint jresult = 0 ;
...
Java_co_airbitz_api_Jni_coreDataSyncWallet(JNIEnv *jenv, jclass jcls, jstring jusername, jstring jpassword, jstring juuid, jlong jerrorp) {
  jint jresult = 0 ;
  char *username = (char *) 0 ;
  char *password = (char *) 0 ;
  char *uuid = (char *) 0 ;
...
Java_co_airbitz_api_Jni_coreSweepKey(JNIEnv *jenv, jclass jcls, jstring jusername, jstring jpassword, jstring juuid, jstring jwif, jlong ppchar, jlong jerrorp) {
  jint jresult = 0 ;
  char *username = (char *) 0 ;
  char *password = (char *) 0 ;
  char *uuid = (char *) 0 ;
...
JNIEXPORT jint JNICALL
Java_co_airbitz_api_Jni_coreWatcherLoop(JNIEnv *jenv, jclass jcls, jstring juuid, jlong jerrorp) {
  jint jresult = 0 ;
  char *uuid = (char *) 0 ;
  tABC_BitCoin_Event_Callback callback = (tABC_BitCoin_Event_Callback) 0 ;
  void *bcInfo = (void *) 0 ;
...
Java_co_airbitz_api_CoreAPI_RegisterAsyncCallback (JNIEnv * env, jobject obj)
{
...
Java_co_airbitz_api_Jni_getStringAtPtr( JNIEnv *env, jobject obj, jlong ptr )
{
...
Java_co_airbitz_api_Jni_getBytesAtPtr( JNIEnv *env, jobject obj, jlong ptr , jint len)
{
...
Java_co_airbitz_api_Jni_getCoreCurrencyNumbers(JNIEnv *env, jclass cls)
{
    jintArray result;
 ...
 */
JNIEXPORT jstring JNICALL
Java_co_airbitz_api_Jni_getCurrencyCode( JNIEnv *env, jobject obj, jint currencyNum)
{
 ...
 */
JNIEXPORT jstring JNICALL
Java_co_airbitz_api_Jni_getCurrencyDescription( JNIEnv *env, jobject obj, jint currencyNum)
{
...
Java_co_airbitz_api_Jni_get64BitLongAtPtr(JNIEnv *env, jobject obj, jlong ptr)
{
    char *base = *(char **) &ptr;
    int i=0;
    long long result = 0;
...
Java_co_airbitz_api_Jni_set64BitLongAtPtr(JNIEnv *jenv, jclass jcls, jlong obj, jlong value) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_co_airbitz_api_Jni_getLongAtPtr(jlong *obj)
{
    return *obj;
}
...
*/
JNIEXPORT jlong JNICALL
Java_co_airbitz_api_Jni_ParseAmount(JNIEnv *jenv, jclass jcls, jstring jarg1, jint decimalplaces) {
  tABC_CC result;
...
*/
JNIEXPORT jint JNICALL
Java_co_airbitz_api_Jni_FormatAmount(JNIEnv *jenv, jclass jcls, jlong satoshi, jlong ppchar, jlong decimalplaces, jboolean addSign, jlong perror) {
  jint jresult = 0 ;
...
*/
JNIEXPORT jint JNICALL
Java_co_airbitz_api_Jni_satoshiToCurrency( JNIEnv *jenv, jobject obj,
